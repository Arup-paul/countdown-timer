...
export declare interface PluginContainer {
    ...
    resolveId(id: string, importer?: string, skip?: Plugin[], ssr?: boolean): Promise<PartialResolvedId | null>;
...
export declare type ResolvedConfig = Readonly<Omit<UserConfig, 'plugins' | 'alias' | 'assetsInclude'> & {
...
export declare function resolvePackageEntry(id: string, { resolvedImports, dir, data }: PackageData, options: ResolveOptions): string | undefined;
...
export declare interface ViteDevServer {
     ...
     */
    ssrLoadModule(url: string, options?: {
        isolated?: boolean;
